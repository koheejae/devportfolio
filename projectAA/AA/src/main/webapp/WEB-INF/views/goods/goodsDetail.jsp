...
<script type="text/javascript">
   ...
   function fn_order_each_goods(goods_num,goods_option,qty){
   var _isLogOn=document.getElementById("isLogOn");
   var isLogOn=_isLogOn.value;
            ...
            <div class="tab_content" id="tab2">
               ...
               <div class="price">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td class="td_1"></td>
                        <td><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_num }','standard','1');"><input type="button" value="구매하기"></a></td>
                        <td><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_num }','deluxe','1');"><input type="button" value="구매하기"></a></td>
                        <td><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_num }','premium','1');"><input type="button" value="구매하기"></a></td>
                     </tr>
                  </tbody>
                  </table>
               </div>
      ...
      <fmt:formatNumber  value="${goods.goods_standardPrice}" type="number" var="goods_standardPrice"/>
         ...
         <b>${goods.goods_intro}</b>
             <table>
                ...
                <tr>
                <td><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_num }','standard',document.getElementById('cart_goods_qty1').value);"><input type="button" value="구매하기"></a></td>
      ...
      <h1>
         ...
         <b>${goods.goods_intro}</b>
              <table>
                 ...
                 <tr>
                 <td><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_num }','deluxe',document.getElementById('cart_goods_qty2').value);"><input type="button" value="구매하기"></a></td>
         ...
         <h1>
            ...
            <b>${goods.goods_intro}</b>
              <table>
                 ...
                 <tr>
                 <td><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_num }','premium',document.getElementById('cart_goods_qty3').value);"><input type="button" value="구매하기"></a></td>
