...
<c:when test="${memberInfo.id != null}">
  <td colspan=2 align="left"><input type="text" size="20" maxlength="100" value="${memberInfo.id}" readonly/></td>
	     ...
	     <tr>
			   ...
			   <td colspan="2"><input type="text" size="60"  maxlength="500" name="board_title" /></td>
		 </tr>
	 		<tr>
				<td align="right" valign="top"><br>글내용: </td>
				<td colspan=2><textarea name="board_content" rows="10" cols="65" maxlength="4000"></textarea> </td>
     </tr>
     <tr>
