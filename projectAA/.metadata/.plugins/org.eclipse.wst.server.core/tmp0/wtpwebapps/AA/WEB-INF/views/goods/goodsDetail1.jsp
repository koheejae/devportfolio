...
<script type="text/javascript">
	...
	function add_cart(goods_num,order_goods_qty) {
		$.ajax({
			type : "post",
...
function fn_order_each_goods(goods_num,goods_title,goods_sales_price,fileName){
...
<body>
	...
	<div id="detail_table">
		...
		<ul>
			<li><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_num }','${goods.goods_title }','${goods.goods_sales_price}','${goods.goods_fileName}');">구매하기 </a></li>
			<li><a class="cart" href="javascript:add_cart('${goods.goods_num }','order_goods_qty')">장바구니</a></li>
